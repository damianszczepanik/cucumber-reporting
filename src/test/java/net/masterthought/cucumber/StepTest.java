...
public class StepTest {
    ...
    public void shouldCreateLinkToScreenshotWhenOneExists() throws IOException {
        ...
        assertThat(failingStepWithEmbeddedScreenshot().getAttachments().replaceAll("embedding_[-\\d]+", "embedding_1234"),
                is("<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 1 (png)</a><div id=\"embedding_1234\" class=\"hidden\"><img id=\"embedding_1234\" src=\"data:image/png;base64,\"></div></div>"
                 + "<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 2 (png)</a><div id=\"embedding_1234\" class=\"hidden\"><img id=\"embedding_1234\" src=\"data:image/png;base64,R0lGODlhDwAPAKECAAAAzMzM/////wAAACwAAAAADwAPAAACIISPeQHsrZ5ModrLlN48CXF8m2iQ3YmmKqVlRtW4MLwWACH+H09wdGltaXplZCBieSBVbGVhZCBTbWFydFNhdmVyIQAAOw==\"></div></div>"
                 + "<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 3 (jpeg)</a><div id=\"embedding_1234\" class=\"hidden\"><img id=\"embedding_1234\" src=\"data:image/jpeg;base64,\"></div></div>"
                 + "<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 4 (plain text)</a><div id=\"embedding_1234\" class=\"hidden\"><pre>java.lang.Throwable</pre></div></div>"
                 + "<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 5 (HTML)</a><div id=\"embedding_1234\" class=\"hidden\"><i>Hello</i> <b>World!<b></div></div>"
                 + "<div class=\"embedding\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 6 (unknown)</a><div id=\"embedding_1234\" class=\"hidden\">File the <a href=\"https://github.com/damianszczepanik/cucumber-reporting/issues\">bug</a> so support for this mimetype can be added.</div></div>"));
    }
