    ...
    public void shouldCreateLinkToScreenshotWhenOneExists() throws IOException {
        ...
        assertThat(failingStepWithEmbeddedScreenshot().getAttachments().replaceAll("embedding-[-\\d]+", "embedding-1234"),
                       is("<a onclick=\"attachment=document.getElementById('embedding-1234'); attachment.style.display = (attachment.style.display == 'none' ? 'block' : 'none');return false\" href=\"#\">Attachment 1 (image)</a><a href=\"data:image/png;base64,\"><img id=\"embedding-1234\" src=\"data:image/png;base64,\" style=\"display:none;\"/></a></br>"
                        ...
                        + "<a onclick=\"attachment=document.getElementById('embedding-1234'); attachment.style.display = (attachment.style.display == 'none' ? 'block' : 'none');return false\" href=\"#\">Attachment 3 (plain text)</a><pre id=\"embedding-1234\" style=\"display:none;\">java.lang.Throwable</pre><br>"
                        + "<a onclick=\"attachment=document.getElementById('embedding-1234'); attachment.style.display = (attachment.style.display == 'none' ? 'block' : 'none');return false\" href=\"#\">Attachment 4 (HTML text)</a><span id=\"embedding-1234\" style=\"display:none;\"><i>Hello</i> <b>World!<b></span><br><span style=\"color:red\">Attachment number 4, has unsupported mimetype 'unknown'.<br>File the bug <a href=\"https://github.com/damianszczepanik/cucumber-reporting/issues\">here</a> so support will be added!</span><br>"));
    }
