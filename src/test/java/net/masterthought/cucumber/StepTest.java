...
public class StepTest {
    ...
    public void shouldCreateLinkToScreenshotWhenOneExists() throws IOException {
        ...
        assertThat(failingStepWithEmbeddedScreenshot().getAttachments().replaceAll("embedding_[-\\d]+", "embedding_1234"),
                is("<div class=\"embedding indention\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 1 (png)</a><div id=\"embedding_1234\" class=\"hidden\"><span class=\"embedding-box\"><img id=\"embedding_1234\" src=\"data:image/png;base64,\"></span></div></div>"
                 + "<div class=\"embedding indention\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 2 (png)</a><div id=\"embedding_1234\" class=\"hidden\"><span class=\"embedding-box\"><img id=\"embedding_1234\" src=\"data:image/png;base64,R0lGODlhDwAPAKECAAAAzMzM/////wAAACwAAAAADwAPAAACIISPeQHsrZ5ModrLlN48CXF8m2iQ3YmmKqVlRtW4MLwWACH+H09wdGltaXplZCBieSBVbGVhZCBTbWFydFNhdmVyIQAAOw==\"></span></div></div>"
                 + "<div class=\"embedding indention\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 3 (jpeg)</a><div id=\"embedding_1234\" class=\"hidden\"><span class=\"embedding-box\"><img id=\"embedding_1234\" src=\"data:image/jpeg;base64,\"></span></div></div>"
                 ...
                 + "<div class=\"embedding indention\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 5 (HTML)</a><div id=\"embedding_1234\" class=\"hidden\"><span class=\"embedding-box\"><i>Hello</i> <b>World!<b></span></div></div>"
                 + "<div class=\"embedding indention\"><a onclick=\"attachment=document.getElementById('embedding_1234'); attachment.className = (attachment.className == 'hidden' ? 'visible' : 'hidden'); return false\" href=\"#\">Attachment 6 (unknown)</a><div id=\"embedding_1234\" class=\"hidden\"><span class=\"embedding-box\">File the <a href=\"https://github.com/damianszczepanik/cucumber-reporting/issues\">bug</a> so support for this mimetype can be added.</span></div></div>"));
    }
