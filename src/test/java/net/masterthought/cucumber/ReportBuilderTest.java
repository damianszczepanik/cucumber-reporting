...
public class ReportBuilderTest extends ReportGenerator {
    ...
    public void setUp() throws IOException {
        ...
        new File(reportDirectory, ReportBuilder.BASE_DIRECTORY + configuration.getDirectoryQualifier()).mkdir();
    ...
    public void cleanUp() throws IOException {
        ...
        if (configuration != null) {
			FileUtils.deleteDirectory(new File(configuration.getReportDirectory(), 
					ReportBuilder.BASE_DIRECTORY + configuration.getDirectoryQualifier()));
        }
    }
    ...
    public void generateReports_OnException_AppendsBuildToTrends() {
        ...
        // then
        assertPageExists(reportDirectory, configuration.getDirectoryQualifier(), ReportBuilder.HOME_PAGE);
    ...
    public void copyResources_OnInvalidPath_ThrowsException() {
        ...
        Configuration configuration = new Configuration(reportDirectory, "myProject");
        ReportBuilder builder = new ReportBuilder(Collections.<String>emptyList(), configuration);
        File dir = new File(reportDirectory, ReportBuilder.BASE_DIRECTORY + configuration.getDirectoryQualifier());
    ...
    private File[] countHtmlFiles(Configuration configuration) {
    	...
    	File dir = new File(configuration.getReportDirectory(), ReportBuilder.BASE_DIRECTORY + configuration.getDirectoryQualifier());
    ...
    private static void assertPageExists(File reportDirectory, String directoryQualifier, String fileName) {
        File errorPage = new File(reportDirectory, ReportBuilder.BASE_DIRECTORY + directoryQualifier + File.separatorChar + fileName);
