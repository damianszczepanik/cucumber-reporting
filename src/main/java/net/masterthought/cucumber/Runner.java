...
//            list.add("/Users/kings/.jenkins/jobs/cucumber-jvm/builds/7/cucumber-html-reports/project2.json");
//
//           ReportBuilder reportBuilder = new ReportBuilder(list,rd,"","7","cucumber-jvm",false,false,true,true,true,"Account has sufficient funds again~the account balance is 300~account~scenario1_psp_auth_request.xml~xml\nAccount has sufficient funds again~the card is valid~card~scenario1_psp_auth_response.xml~xml");
