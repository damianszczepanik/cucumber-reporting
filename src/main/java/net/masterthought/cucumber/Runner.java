...
public class Runner {
    ...
    public static void main(String[] args) throws Exception {
        File rd = new File("/Users/kings/.jenkins/jobs/cucumber-jvm/builds/95/cucumber-html-reports");
...
//        list.add("/Users/kings/development/projects/cucumber-reporting/src/test/resources/net/masterthought/cucumber/project2.json");
        ...
        ReportBuilder reportBuilder = new ReportBuilder(list,rd,"","95","cucumber-jvm",false,false,true,true,true,"Account has sufficient funds again~the account balance is 300~account~scenario1_psp_auth_request.xml~xml\nAccount has sufficient funds again~the card is valid~card~scenario1_psp_auth_response.xml~xml");
