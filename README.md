...
You can [play](http://damianszczepanik.github.io/cucumber-html-reports/overview-features.html) with the demo report before you decide if this is worth to install. Mind that not all features are enabled as the report is generated by [sample code](./src/test/java/HelloCucumber.java).
